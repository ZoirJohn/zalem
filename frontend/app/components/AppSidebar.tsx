...
export function AppSidebar({
    ...
    return (
        ...
        >
            <SidebarHeader
                className={clsx(
                    "gap-3.5 bg-claude-canvas p-4",
                    !open && !isMobile && "invisible",
                )}
            >
                <div className="flex w-full items-center justify-between">
                    <div className="text-base font-medium text-claude-ink">
                        Messages
                    </div>
                    <Button
                        variant="ghost"
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                clsx(
                                    ...
                                    !open && "px-2",
                                    isActive &&
                                        "bg-claude-surface-card font-medium text-claude-ink",
                                )
                            }
                            onClick={() => setOpenMobile(false)}
                        >
