            ...
            <div className="mx-auto flex min-h-dvh max-w-[1200px] flex-col gap-8 px-6 py-8 sm:gap-16 sm:px-10 lg:px-12">
                ...
                <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
                    <div className="flex flex-col gap-6">
                        <h1 className="text-4xl leading-[1.05] font-normal tracking-[-0.02em] text-claude-ink sm:text-5xl lg:text-6xl">
                            A calm home base for the projects that power your workflow.
                        </h1>
                        <p className="max-w-2xl text-base leading-relaxed text-claude-body sm:text-lg">
                            This space gathers the subprojects that make up the ecosystem. Each one focuses on a
                            different layer of the work—conversation, collaboration, and quality. Use the cards below to
                            jump into the experience you need today.
                        </p>
                        <div className="flex flex-wrap gap-3">
                            ...
                            <Button
                                asChild
                                variant="secondary"
                                className="h-10 rounded-[8px] border border-claude-hairline bg-claude-canvas px-6 text-sm font-medium text-claude-ink hover:bg-claude-surface-card"
                            >
                    ...
                    <div className="rounded-[16px] border border-claude-hairline bg-claude-surface-card p-8">
                        ...
                        <p className="mt-4 text-sm leading-relaxed text-claude-body">
                            Each subproject is designed as a focused surface. Together they form a warm, editorial
                            experience that balances soft cream canvases with deep product surfaces.
                        </p>
                        <ul className="mt-6 space-y-4 text-sm text-claude-body-strong">
                            ...
                            <li className="flex items-start gap-3">
                                <span className="mt-1 h-2 w-2 rounded-full bg-claude-primary" />A shared tone: calm,
                                warm, and confident.
                            </li>
                        </ul>
                    </div>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {projects.map((project) => {
                        ...
                        return (
                            <article
                                key={project.title}
                                className={`flex h-full flex-col justify-between rounded-[12px] border px-5 py-7 sm:px-8 sm:py-10 ${
                                    isDark
                                        ? "border-claude-surface-dark-soft bg-claude-surface-dark text-claude-canvas"
                                        : "border-claude-hairline bg-claude-surface-card text-claude-ink"
                                }`}
                            >
                                <div>
                                    <p
                                        className={`text-xs font-medium tracking-[0.3em] uppercase ${
                                            isDark ? "text-claude-muted-soft" : "text-claude-muted"
                                        }`}
                                    >
                                        Subproject
                                    </p>
                                    <h3 className="mt-4 text-2xl leading-snug font-normal tracking-[-0.01em]">
                                        {project.title}
                                    </h3>
                                    <p
                                        className={`mt-4 text-sm leading-relaxed ${
                                            isDark ? "text-claude-muted-soft" : "text-claude-body"
                                        }`}
                                    >
                                        {project.description}
                                    </p>
                                ...
                                <div className="mt-8">
                                    <Button
                                        asChild
                                        className={`h-10 rounded-[8px] px-5 text-sm font-medium ${
                                            isDark
                                                ? "bg-claude-surface-dark-elevated text-claude-canvas hover:bg-claude-surface-dark-soft"
                                                : "bg-claude-primary text-white hover:bg-claude-primary-active"
                                        }`}
                                    >
                ...
                <div className="rounded-[12px] border border-claude-hairline bg-claude-canvas p-8 text-claude-ink">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-claude-body">
