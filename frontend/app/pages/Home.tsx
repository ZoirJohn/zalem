    ...
    return (
      <li>
        <Link
          to={conLink}
          target="_blank"
          className="block text-center sm:text-3xl text-xl"
        >
          {conName}
        </Link>
      </li>
  ...
  return (
    <section className="bg-[#72757e]">
      <div className="mx-auto grid min-h-screen max-w-4xl grid-cols-2 grid-rows-[auto_1fr_200px] gap-3 p-3">
        <header className="component-style col-span-2 flex sm:justify-between justify-center gap-3 px-3 py-5 max-md:flex-wrap sm:px-6 sm:py-10">
        ...
        <div className="component-style flex flex-wrap items-center justify-center gap-2 p-6 max-sm:col-span-2">
          ...
          <Button variant="secondary" className="size-8 text-xl" onClick={copy}>
            {copied ? (
